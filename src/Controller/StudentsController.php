...
class StudentsController extends AppController
{
    ...
    {
        $student = $this->Students->get($id, contain: ['Users', 'UserGroups']);
    ...
    public function add()
    {
        ...
        $userGroups = $this->Students->UserGroups->find('list', limit: 200)->all();
        $this->set(compact('student', 'users', 'userGroups'));
    }
